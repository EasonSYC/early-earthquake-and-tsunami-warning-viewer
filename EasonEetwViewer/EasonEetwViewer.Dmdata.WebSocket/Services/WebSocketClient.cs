...
internal sealed class WebSocketClient : IWebSocketClient
{
    ...
    private void HandleJsonData(string finalString)
    {
        try
        {
            ...
            DataReceived?.Invoke(this, new Events.DataReceivedEventArgs() { Telegram = data });
        }
    ...
    public async Task ConnectAsync(Uri webSocketUrl)
    {
        ...
        StatusChanged?.Invoke(this, new() { IsConnected = true });
    ...
    public async Task DisconnectAsync()
    {
        ...
        StatusChanged?.Invoke(this, new() { IsConnected = false });
